...
const Manager = () => {
    ...
    const savePassword = async () => {
        if (form.site.length > 3 && form.site.username > 3 && form.site.password > 3) {
            ...
            let res = await fetch("http://localhost3000/", {method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({...form, id: uuidv4()})})
    ...
    const deletePassword = async (id) => {
        ...
        if (c) {
            ...
            let res = await fetch("http://localhost3000/", {method: "DELETE", headers: { "Content-Type": "application/json" }, body: JSON.stringify({...form, id})})
                    ...
                    <div className="flex flex-col md:flex-row w-full justify between gap-8">
                        ...
                        <div className="relative">
                            ...
                            <span className="absolute right-[1px] top-[1px] cursor-pointer" onClick={showPassword}>
                                <img ref={ref} className="p-1" width={30} src="eye.jpg" alt="eye" />
                            </span>
                        </div>
